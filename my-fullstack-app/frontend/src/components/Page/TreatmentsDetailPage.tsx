        ...
        <Stepper ref={stepperRef} style={{ flexBasis: '100%' }}>
            <StepperPanel header="症狀描述">
                ...
                <div className="flex pt-4 justify-content-end">
                    <Button label="下一步" icon="pi pi-arrow-right" iconPos="right" onClick={() => stepperRef.current?.nextCallback()} />
                </div>
            </StepperPanel>
            <StepperPanel header="醫師診療">
                <div className="flex flex-column">
                  <div className="grid formgrid p-fluid gap-3 justify-content-center">
                    <div className="col-12 md:col-6">
                      <label>主觀症狀 (S)</label>
                      <InputTextarea name="subjective" rows={4} value={formData.subjective} onChange={handleChange} />
                    </div>

                    <div className="col-12 md:col-5">
                      <label>客觀檢查 (O)</label>
                      <InputTextarea name="objective" rows={4} value={formData.objective} onChange={handleChange} />
                    </div>

                    <div className="col-12 md:col-6">
                      <label>專業判斷 (A)</label>
                      <InputTextarea name="assessment" rows={4} value={formData.assessment} onChange={handleChange} />
                    </div>

                    <div className="col-12 md:col-5">
                      <label>治療計畫 (P)</label>
                      <InputTextarea name="plan" rows={4} value={formData.plan} onChange={handleChange} />
                    </div>
                  </div>
                </div>
            ...
            <StepperPanel header="檔案上傳">
              <div className="flex flex-column ">
                ...
                <div className="flex pt-4 justify-content-between">
                    <Button label="上一步" severity="secondary" icon="pi pi-arrow-left" onClick={() => stepperRef.current?.prevCallback()} />
                    <Button label="結案" icon="pi pi-check" iconPos="right" onClick={() => stepperRef.current?.prevCallback()} />
                </div>
            </StepperPanel>
        </Stepper>
    </div>
